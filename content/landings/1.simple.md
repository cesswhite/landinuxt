---
title: "simple"
description: "This landing page includes all the necessary sections to showcase a minimum viable product or a SaaS service"
dark: true
animated: false
parent: "landings"
component: 1
...
<template>
  <div id="landing-one" class="relative h-auto w-full">
    <!-- HEADER -->
    <header
      class="bg-dark-50/10 dark:bg-dark-950/10 relative top-0 z-50 flex w-full items-center justify-between px-4 py-4 backdrop-blur-sm"
    >
      <div class="size-8">
        <NuxtImg
    ...
    >
      ...
      <div class="relative z-10 mx-auto mt-12 w-full p-4 md:p-2 xl:max-w-7xl">
        <NuxtImg
    ...
    <div class="bg-dark-50 dark:bg-dark-950 relative h-auto w-full pt-32">
      ...
      <UContainer>
        <div
          class="font-family-inter mt-8 grid grid-cols-12 gap-4 p-4 md:mt-24"
        >
        ...
        >
          <div class="flex flex-col items-start justify-start gap-y-2">
            ...
            <p class="text-dark-50/70 w-full text-base font-medium lg:w-1/2">
              ...
              Nuxt UI. Copy, paste, and customize easily to create effective
