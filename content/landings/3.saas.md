        ...
        >
          <template v-for="image in images" :key="image.src">
            <div class="flex flex-1 flex-col">
              ...
              <p
                class="text-dark-950/60 dark:text-dark-50/60 mx-auto mt-2 w-full text-center text-base font-normal md:w-1/2 lg:w-full"
              >
                {{ image.description }}
              </p>
            </div>
              ...
              <UCollapsible class="flex flex-col gap-2" :defaultOpen="faq.open">
                ...
                >
                  <template #trailing>
                    <UIcon
                      :name="
                        faq.open ? 'i-lucide-minus' : 'i-lucide-plus'
                      "
                    />
                  </template>
                </UButton>
