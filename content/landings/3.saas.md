...
```vue
<template>
  <div id="landing-three" class="relative h-auto w-full">
    <!-- HEADER -->
    <header
      class="fixed top-12 z-50 flex w-full items-center justify-between px-4 py-2"
    >
      <div class="size-8">
        <NuxtImg
      ...
      <div
        class="center-center border-dark-200/60 bg-dark-50/30 dark:border-dark-500/5 dark:bg-dark-900/90 hidden items-center justify-center rounded-full border px-24 py-1 backdrop-blur md:flex"
      >
    ...
    <!-- HERO -->
    <div
      class="bg-dark-50 dark:bg-dark-950 relative flex h-dvh w-full items-center justify-center overflow-hidden"
    >
      <!-- SVG Container -->
      <div
      ...
      <div class="relative z-30">
        <div class="flex flex-col items-center justify-center px-4">
          ...
          <h1
            class="via-primary-900/90 to-primary-600/90 dark:via-primary-200/90 dark:to-primary-400/90 font-family-inter from-dark-950/90 dark:from-dark-50/90 mt-4 bg-gradient-to-br from-55% via-70% to-85% bg-clip-text text-center text-5xl font-bold text-transparent sm:text-6xl lg:text-7xl"
          >
          ...
          >
            Join our startup and experience the thrill of traveling to space
    ...
    <div class="bg-dark-50 dark:bg-dark-950 relative w-full py-24">
      <UContainer>
        <h2
          class="text-dark-900 dark:text-dark-50 text-left text-4xl font-bold sm:text-4xl md:text-5xl"
        >
          Our Partners
        </h2>
        <p
          class="text-dark-950/60 dark:text-dark-50/60 mt-2 text-left text-lg font-normal"
        >
    ...
    <!-- FEATURES -->
    <div class="bg-dark-50 dark:bg-dark-950 flex w-full flex-col py-24">
      <UContainer>
        <div class="flex w-full flex-col gap-4 md:flex-row md:gap-0">
          ...
          >
            ...
            <h1
              class="text-dark-950 dark:text-dark-50 mt-2 text-center text-4xl font-semibold sm:text-4xl md:text-5xl"
            >
              Build your Dream Home
            </h1>
            <p
              class="text-dark-950/60 dark:text-dark-50/60 mt-2 w-full px-8 text-center text-lg md:px-0"
            >
        ...
        >
          <template v-for="image in images" :key="image.src">
            <div class="flex flex-1 flex-col">
              ...
              />
              <span
                class="text-dark-950 dark:text-dark-50 mt-2 inline-block text-center text-2xl font-medium"
              >
                {{ image.name }}
              </span>
              <p
                class="text-dark-950/60 dark:text-dark-50/60 mt-2 mx-auto w-full text-center text-base font-normal md:w-1/2 lg:w-full"
              >
                {{ image.description }}
              </p>
            </div>
    ...
    <div class="bg-primary-700 relative w-full py-32">
      <div class="flex flex-col gap-y-4">
        <h1
          class="text-dark-50 text-center text-4xl font-bold sm:text-4xl md:text-5xl"
        >
            ...
            <template v-for="(testimonial, index) in testimonials">
              <div class="col-span-full gap-4 lg:col-span-4">
                ...
                >
                  ...
                  <p
                    class="text-dark-950/60 dark:text-dark-50/60 mt-8 text-base"
                  >
                    {{ testimonial.text }}
                  </p>
    ...
    <div class="bg-dark-50 dark:bg-dark-950 relative w-full py-24">
      <UContainer>
        <div class="flex flex-col">
          <h1
            class="text-dark-900 dark:text-dark-100 text-4xl font-semibold md:text-5xl"
          >
      ...
      <UContainer>
        <div class="relative grid w-full grid-cols-12 gap-4">
          <div class="col-span-full p-4 md:col-span-6">
            <div
              class="flex h-auto w-full flex-col items-start justify-between"
            >
              <div class="relative">
                <h2
                  class="text-dark-900 dark:text-dark-50 text-4xl font-semibold md:text-5xl"
                >
    ...
    <!-- FOOTER -->
    <footer
      class="bg-dark-50 dark:bg-dark-950 border-dark-950/10 dark:border-dark-50/50 relative w-full border-t py-12 pt-24"
    >
      <UContainer>
        <div
        ...
        >
          <div class="flex w-full flex-col md:w-1/2">
            <span
              class="text-dark-950/50 dark:text-dark-50/50 inline-block text-sm"
            >
              (000) 000-0000
            </span>
            <span
          ...
          >
            ...
            <div class="flex flex-col gap-y-2">
              <template
                v-for="(b_nav, index) in bottom_navigation"
                :key="index"
              >
                <UButton
                  :to="b_nav.link"
