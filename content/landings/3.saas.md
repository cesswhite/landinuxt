    ...
    >
      ...
      <div class="relative z-30">
        <div class="flex flex-col items-center justify-center px-4">
          ...
          <h1
            class="via-primary-900/90 to-primary-600/90 dark:via-primary-200/90 dark:to-primary-400/90 font-inter from-dark-950/90 dark:from-dark-50/90 mt-4 bg-gradient-to-br from-55% via-70% to-85% bg-clip-text text-center text-5xl font-bold text-transparent sm:text-6xl lg:text-7xl"
          >
