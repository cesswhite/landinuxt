---
title: "simple"
description: "Hero section with background image and simple title with button action"
dark: false
parent: "hero"
component: 1
preview: true
...
<template>
  ...
  >
    ...
    <!-- Overlay -->
    <div
      class="absolute left-0 top-0 h-full w-4/5 bg-gradient-to-r from-gray-950/70"
    ></div>
