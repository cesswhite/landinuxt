...
<template>
  ...
  >
    <div class="dark:border-dark-50 grid grid-cols-12 border border-gray-950">
      <div
        class="col-span-full flex flex-col items-start justify-start gap-y-4 border-b border-gray-950 p-8 lg:col-span-6 lg:border-r lg:border-b-0 dark:border-gray-50"
      >
      ...
      <ul
        class="dark:border-dark-50 col-span-full flex flex-col gap-y-4 border-gray-950 pb-4 sm:col-span-4 sm:border-r lg:col-span-2"
      >
        <template v-for="(nav, index) in navigation" :key="index">
          <li
            class="text-dark-950 dark:text-dark-50 font-inter dark:border-dark-50 border-b border-gray-950 p-4 text-base capitalize uppercase"
          >
            {{ nav.label }}
          </li>
          <li
      ...
      <ul
        class="dark:border-dark-50 col-span-full flex flex-col gap-y-4 border-t border-gray-950 pb-4 sm:col-span-4 sm:border-t-0 sm:border-r lg:col-span-2 dark:border-gray-50"
      >
      ...
      <div
        class="col-span-full flex w-full flex-col items-center justify-center gap-4 border-t border-gray-950 py-4 md:flex-row dark:border-gray-50"
      >
      ...
      <div
        class="col-span-full flex w-full flex-col items-center justify-center gap-4 border-t border-gray-950 p-4 md:flex-row dark:border-gray-50"
      >
        <div
