---
title: "store"
description: "E-commerce header component with navigation and search functionality"
dark: true
parent: "headers"
component: 6
preview: true
...
<template>
  ...
  >
    ...
    <div class="flex items-center gap-2">
      <UButton
        ...
        color="primary"
        size="lg"
        @click="isOpenCommandPaletteToSearch = true"
      />
  ...
  <UModal v-model="isOpenCommandPaletteToSearch">
    <UCommandPalette
      v-model="selected"
      multiple
      nullable
      :groups="[{ key: 'categories', commands: categories }]"
    />
  </UModal>
  <USlideover v-model="isOpenResponsiveMenu" side="left">
    <div class="p-4">
...
const isOpenCommandPaletteToSearch = ref(false);
const selected = ref([]);
