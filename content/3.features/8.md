  ...
  <div class="flex w-full flex-col gap-y-32">
    <template v-for="(feat, index) in features" :key="index">
      ...
      >
        ...
        >
          <span
            class="font-instrument text-4xl text-dark-950 lg:text-6xl dark:text-dark-50"
          >
            {{ feat.title }}
          </span>
          <p
            class="font-instrument text-xl text-dark-950/50 lg:text-2xl dark:text-dark-50/50"
          >
            {{ feat.description }}
          </p>
