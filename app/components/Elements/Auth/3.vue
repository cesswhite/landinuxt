        ...
        <div
            ...
            <div class="relative">
                <div class="flex flex-col items-center justify-center">
                    ...
                    <h1 class="w-full text-center font-bold text-lg text-dark-950 dark:text-dark-50">Welcome back
                    </h1>
                    ...
                    <div class="flex flex-col gap-y-2 w-full mt-8">
                        ...
                        <UButton block type="submit" size="lg" class="cursor-pointer" color="neutral"
                ...
                <div class="w-full relative">
                    <UForm :validate="validate" :state="state" class="grid grid-cols-12 gap-4" @submit="onSubmit">
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-4">
                                <small
                                    class="text-dark-950/50 dark:text-dark-50/50 text-xs text-center inline-block w-full">
                                    Don't have an account? <NuxtLink to="#"
                                        class="text-primary-500 dark:text-primary-400">Sign up
                                    </NuxtLink>
                                </small>
                            </div>
                        </div>
