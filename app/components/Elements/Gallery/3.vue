        ...
        <div class="mx-auto flex flex-col gap-8 mt-12">
            ...
            <UMarquee :repeat="4" pause-on-hover :overlay="false" :ui="{
                ...
                <NuxtImg v-for="(image, index) in marquee1" :key="`marquee1-${index}`" :src="image"
                    :alt="`Tattoo preview ${index + 1}`" width="1280" height="100%" sizes="1280px" format="webp"
                    quality="90" class="size-64 md:size-80 object-cover object-center rounded-2xl shrink-0"
                    loading="lazy" />
            </UMarquee>
