<template>
  <div class="flex w-full flex-col gap-12 rounded-xl bg-dark-50  p-4 md:gap-24 dark:bg-dark-950">
    <div v-motion :initial="{ opacity: 0, y: 16 }" :enter="{ opacity: 1, y: 0 }" :duration="450"
