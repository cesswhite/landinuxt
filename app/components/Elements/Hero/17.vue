<template>
    <div class="h-auto min-h-dvh w-full dark:bg-dark-950 flex flex-col items-center justify-center relative">
        ...
        <div class="relative z-30 pt-44 md:pt-0">
            <UContainer>
                <h1
                    class="text-left text-dark-50 text-5xl md:text-7xl font-bold font-inter tracking-tighter md:leading-[3.8rem]">
                    Discover the Perfect Blend of Coffee and Community
                </h1>
                <p class="text-dark-50/80 mt-4 text-left text-lg md:text-xl 2xl:text-xl font-inter w-full lg:w-1/2">
