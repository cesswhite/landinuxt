<template>
  <div id="landing-two" class="relative h-auto w-full">
    ...
    <div class="relative flex h-full min-h-dvh w-full items-center justify-center">
      ...
      <div class="relative z-20 w-10/12">
        <div class="flex flex-col gap-4">
          <h1 class="text-center text-5xl font-semibold text-white sm:text-6xl md:text-left md:text-7xl 2xl:text-8xl">
            Support your <br />
            friends with <br />
            heartfelt care
          </h1>
    ...
    <!-- FEATURES -->
    <div class="flex h-auto w-full flex-col py-24 md:gap-24 bg-dark-50 dark:bg-dark-950">
      <UContainer>
        ...
        <div class="grid grid-cols-12 gap-y-16 md:gap-x-6 mt-24">
          <template v-for="(feat, index) in features" :key="index">
            <div
              ...
              <div
                class="flex h-10 w-10 max-w-10 min-w-10 max-h-10 min-h-10 flex-auto items-center justify-center rounded-md border border-dark-950/20 bg-dark-950/5 xl:w-44 dark:border-dark-500/50 dark:bg-dark-50/10">
                <UIcon :name="feat.icon" class="size-6 text-dark-950 dark:text-dark-50" />
              </div>
    ...
    <div class="bg-dark-100 dark:bg-dark-900 relative w-full px-4 py-24">
      <UContainer>
        <div class="relative w-full">
          ...
          <div class="col-span-full mt-12 flex flex-wrap justify-center gap-x-12 gap-y-12 md:col-span-6">
      ...
      <UContainer>
        <div class="flex w-full flex-col gap-4 md:flex-row md:gap-0">
          <div class="mx-auto flex w-full flex-col items-center justify-center gap-2 md:w-1/2">
            ...
            <h1 class="mt-1 text-center text-4xl font-medium text-dark-950 sm:text-4xl md:text-5xl dark:text-dark-50">
    ...
    <div class="bg-dark-50 relative h-auto w-full py-24 dark:bg-dark-950">
      <div class="flex flex-col items-center justify-center gap-y-2">
        ...
        <p class="text-dark-950/50 dark:text-dark-50/50 mt-4 mx-auto w-full px-4 text-lg text-center md:w-1/2 md:p-0">
            ...
            <div class="col-span-full grid grid-cols-2 gap-4 lg:col-span-6">
              ...
              <div
                ...
                <div class="mt-12 flex flex-col">
                  ...
                  <span class="text-dark-950/80 dark:text-dark-50/80 mt-1 text-base font-medium">
                    {{ testimonial.name }}
                  </span>
                </div>
              </div>
    ...
    <!-- CTA -->
    <div class="bg-primary-600 dark:bg-primary-500 relative flex h-[520px] w-full flex-col items-start justify-end">
      <div class="w-full max-w-7xl mx-auto px-6">
        <div class="flex w-full items-end justify-between pb-12">
          <h1 class="text-dark-50 dark:text-dark-950 text-5xl font-light md:text-6xl">
            Where Design <br />
            Meets Technology
          </h1>
        ...
        <div class="mt-12 grid w-full grid-cols-12 gap-x-0 gap-y-8 md:gap-x-8">
          <template v-for="(faq, index) in faqs" :key="index">
            <div class="col-span-full md:col-span-4">
              <span class="text-dark-900 dark:text-dark-50 text-base font-semibold">{{ faq.question }}</span>
    ...
    <div class="bg-dark-50 dark:bg-dark-950 relative w-full py-24">
      <UContainer>
        <div class="flex w-full flex-col-reverse gap-8 text-lg py-12 md:grid md:grid-cols-12">
          <div class="relative col-span-full md:col-span-6">
            <h2 class="text-dark-900 dark:text-dark-50 text-4xl font-bold">
              We are here to help you
            </h2>
            <p class="text-lg text-dark-900/60 dark:text-dark-50/60 mt-2">
    ...
    <!-- FOOTER -->
    <footer class="bg-dark-50 dark:bg-dark-950 relative flex h-auto w-full flex-col overflow-hidden p-2">
      <div class="w-full max-w-7xl mx-auto">
        <div class="relative z-10 grid w-full grid-cols-12 gap-y-4 lg:gap-y-0">
          <div class="col-span-full flex flex-col items-start justify-start gap-y-6 lg:col-span-4 xl:col-span-4">
            ...
            <div class="text-dark-950/50 dark:text-dark-50/50 flex items-center justify-start gap-x-4">
