<template>
  <NuxtLayout name="playground">
    <div class="bg-primary-50/50 dark:bg-dark-50/10 relative w-full flex flex-col items-start justify-end">
      <div class="flex flex-col items-center justify-center w-full px-4 py-12 md:p-12 gap-y-8">
        ...
        <UButton variant="solid" to="#" size="xl" trailing-icon="i-heroicons-arrow-right" label="Connect us"
          class="bg-primary-950 text-primary-50 dark:bg-dark-50 dark:text-primary-600 px-12" />
      </div>
    </div>
  </NuxtLayout>
</template>
