      ...
      >
        ...
        <div class="flex flex-1 flex-col gap-2">
          ...
          >
            ...
            comprehensive design services. From initial conceptualization to
            final deployment, we guarantee a smooth integration of the latest
        ...
        <div class="flex flex-1 flex-col gap-2">
          ...
          >
            ...
            integration of the latest technologies to propel your business
            ahead.
          </p>
        </div>
      </div>
