<template>
  <div
    class="flex h-dvh w-full items-center justify-center bg-white p-4 dark:bg-black"
  >
    <div class="relative w-full">
      ...
      >
        ...
        >
          <UButton variant="link" color="gray" size="lg" to="#"> Home </UButton>
          <UButton
          ...
          <UButton variant="link" color="gray" size="lg" to="#">
            Tools
          </UButton>
          <UButton variant="link" color="gray" size="lg" to="#">
            Contact
          ...
          <div class="flex w-3/5 items-center">
            <template v-for="(service, index) in services" :key="index">
              <div class="flex flex-col gap-y-2">
                ...
                <span
                  class="text-base font-bold text-gray-950 dark:text-gray-50"
                >
                  {{ service.name }}
                </span>
                <p
                  class="w-4/5 text-sm font-normal text-gray-950/60 dark:text-gray-50/60"
                >
                  {{ service.description }}
                </p>
              </div>
