        ...
        <div class="mb-12 h-full overflow-hidden rounded-md border border-gray-500/10 p-2 lg:h-full">
            ...
            <div class="text-base">
              <div class="flex items-center gap-2">
                ...
                <UTooltip v-if="item.dark" text="Change the theme to see dark mode">
                  <UIcon name="i-heroicons-moon-20-solid" class="mt-0.5 text-xs dark:text-gray-50" />
                </UTooltip>
              </div>
          ...
          <Transition name="fade" mode="out-in">
            <div v-if="item.preview"
              class="my-4 h-auto min-h-[1024px] overflow-x-hidden overflow-y-scroll rounded-md bg-gray-200/80 p-2 dark:bg-gray-900 scrollbar-hide">
              ...
              <ElementsHero9 v-if="item.title === ('double-image' as HeroTemplates)" />
