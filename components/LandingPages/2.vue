<template>
    <div id="landing-one" class="relative h-auto w-full">
      <!-- HEADER -->
      <header
        class="bg-dark-50/10 dark:bg-dark-950/10 fixed top-8 z-50 flex w-full items-center justify-between px-4 py-4 backdrop-blur-sm"
      >
        <div class="size-8">
          <NuxtImg
      ...
      <!-- HERO -->
      <div
        class="bg-dark-50 dark:bg-dark-950 relative flex h-full min-h-dvh w-full flex-col items-center justify-center pt-32"
      >
        ...
        <div
          class="mt-12 flex w-full flex-wrap items-center justify-center gap-4"
        >
        ...
        <div class="relative z-10 mt-12 mx-auto w-full p-4 md:p-2 xl:max-w-7xl">
          <NuxtImg
      ...
      <div class="bg-dark-50 dark:bg-dark-950 relative w-full px-4 pt-32">
        <UContainer>
          <h2
            class="text-dark-950 dark:text-dark-50 text-center text-5xl font-semibold"
          >
            Our partners
          </h2>
          <p
      ...
      <!-- FEATURES -->
      <div
        class="bg-dark-50 dark:bg-dark-950 flex w-full flex-col gap-12 rounded-xl pt-32 md:gap-24"
      >
        <UContainer>
          <div class="flex w-full flex-col gap-4 md:flex-row md:gap-0">
            <div class="flex w-full flex-col gap-2 md:w-1/2">
              ...
              <h1 class="text-dark-950 dark:text-dark-50 text-7xl font-semibold">
                Safari Tour Experience
              </h1>
            </div>
            <div class="flex w-full items-center justify-start md:w-1/2">
              <p class="font-base text-dark-950/60 dark:text-dark-50/80 w-full">
          ...
          <div
            class="mt-12 flex flex-col items-start justify-between gap-x-16 gap-y-8 md:flex-row"
          >
          ...
          >
            <div class="flex flex-col items-start justify-start gap-y-2">
              ...
              <p class="text-dark-50/70 w-full text-base font-medium lg:w-1/2">
                Discover our collection of ready-to-use components, optimized with
                Nuxt UI v3. Copy, paste, and customize easily to create effective
      ...
      <!-- FOOTER -->
      <footer class="bg-dark-50 dark:bg-dark-950 relative w-full pt-32">
        <UContainer>
