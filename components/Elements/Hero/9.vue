<template>
  <div
    class="relative flex h-dvh w-full items-center justify-center bg-gray-50 dark:bg-gray-950"
  >
    <div
    ...
    >
      <h1
        class="text-center font-sans text-6xl font-extralight text-gray-50 md:text-7xl"
      >
        Unlock your fashion journey!
      </h1>
      <UButton variant="subtle" color="primary" size="xl" class="text-gray-50">
        New collection
      </UButton>
    </div>
  </div>
