    ...
    <div
      ...
      <div class="relative col-span-full mt-28 lg:col-span-1">
        <div class="flex flex-col items-center justify-center lg:items-start">
          ...
          <div class="mt-8 flex w-full items-center justify-center gap-12 lg:items-start lg:justify-start">
            <UIcon name="i-simple-icons-nike" class="text-4xl text-dark-400" />
            <UIcon name="i-simple-icons-google" class="text-4xl text-dark-400" />
            <UIcon name="i-simple-icons-adidas" class="text-4xl text-dark-400" />
            <UIcon name="i-simple-icons-doubanread" class="text-4xl text-dark-400" />
          </div>
        </div>
      </div>
      <div class="relative col-span-full mt-4 lg:col-span-1">
        <NuxtImg class="max-h-[420px] w-full rounded-lg object-cover object-center lg:max-h-[720px]"
          ...
          format="webp" loading="lazy" alt="my-company-hero-image" :placeholder="[50, 25, 75, 5]" />
      </div>
    </div>
  </div>
</template>
