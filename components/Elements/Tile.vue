<template>
  <div
    @click="goToComponentIndex(props.data.name)"
  ...
  >
    <div
      class="bg-dark-200/60 dark:bg-dark-500/10 flex h-56 w-full items-center justify-center rounded-md"
    >
    ...
    <div
      class="text-dark-950/90 dark:text-dark-50/90 mt-2 p-1 text-base font-bold capitalize"
    >
      {{ props.data.name }}
